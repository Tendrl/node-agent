...
from tendrl.integrations.ceph.objects.definition import definitions
...
class Definition(objects.BaseObject):
    def __init__(self, *args, **kwargs):
        ...
        self.value = '_tendrl/integrations/ceph/definitions'
...
class _DefinitionEtcd(etcdobj.EtcdObj):
    ...
    """
    __name__ = '_tendrl/integrations/ceph/definitions'
